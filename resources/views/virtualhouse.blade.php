...
@section('content')
    ...
    <section class="p-content google-virtual-page py-6">
        <div class="container">
            ...
            <div class="featured-sec m-0 mb-8 wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".6s">
                <div class=" featured-img">
                    <img src="{{asset($virtual->image)}}" class="img-responsive" alt="google-virtual-img">
                </div>
                <a href="{{url($vdo3->url)}}" data-fancyBox=""
...
<?=html_entity_decode($virtual->content)?>
            </div>
        </div>
    </section>
