...
Route::get('matterport','HomeController@Matterport')->name('matterport');
Route::get('virtual-house','HomeController@Virtualhouse')->name('virtualhouse');
Route::get('google-virtual-tour','HomeController@Virtualtour')->name('googlevirtualtour');
Route::get('hdrphotograph','HomeController@Hdrphotograph')->name('hdrphotograph');
Route::get('aerial-view','HomeController@Aerialview')->name('aerialview');
Route::get('industries','HomeController@Industries')->name('industries');
Route::get('preparation','HomeController@Preparation')->name('preparation');
Route::get('book-services','HomeController@Bookservices')->name('bookservices');
...
Route::post('book-service','HomeController@BookService')->name('BookService');
...
Route::resource('admin/bookservice', 'Admin\\BookserviceController');
