                    ...
                    <li class="clearfix"></li>
                        ...
                        <li class=""><a class="has-arrow waves-effect waves-dark" href="{{url('dashboard')}}" aria-expanded="false"><i class="flaticon-desktop-computer-screen-with-rising-graph"></i>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{url('admin/innerbanner')}}" class="">Innerbanner</a></li>
                   ...
                   <!--  <li><hr></li>
                    ...
                    <li>
                        <a href="{{url('admin/video')}}">
                            ...
                            </i><span class="hide-menu">Video</span>
                        </a>
                    </li>
                    <li><hr></li>
                     <li>
                        <a href="{{url('admin/bookservice')}}">
                            ...
                            </i><span class="hide-menu">Bookservice</span>
                        </a>
                    </li>
                    <li><hr></li>
                    <li>
                        <a href="{{url('admin/project')}}">
                            ...
                            </i><span class="hide-menu">Project</span>
                        </a>
                    </li>
                    <li><hr></li>
